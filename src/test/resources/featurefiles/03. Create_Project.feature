Feature: Adding Project Functionality for MobiWise Application
  ...
  Scenario Outline: Create a Project
    ...
    Examples:
      ...
      | "dummy"  | "1234567890" | "Projects"      | "New Demo"   | "Demo Description"     | "New Project"    | "New Demo Description"  | "This project name already exists!" | "The selected image does not conform to recommended standards, which may impact the rendering of the icon within the app." |
...
#      | "dummy"  | "1234567890" | "Projects"      | "Demo3"      | ""                     | "New Demo"       | ""                      | "This project name already exists!" | "The selected image does not conform to recommended standards, which may impact the rendering of the icon within the app." |
