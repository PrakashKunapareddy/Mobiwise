Feature: Adding Mobile Application And Web Application for Created Project In MobileWise
  ...
  Scenario Outline: Create Mobile And Web Applications
    ...
    Examples:
      ...
      | "dummy"  | "1234567890" | "Projects"      | " Mobile App "   | ""                | "Application name is required!"                  | "Demo Application Description"                                                           | "Custom Theme"  | "Roboto Flex"     | "Roboto Flex" | "Sucessfully Created Application" | "This is required field!" | "Projects"               |
      ...
      | "dummy"  | "1234567890" | "Projects"      | " Web App "      | "Demo Web App"    | "Application name already exists!"               | "Demo Application Description"                                                           | "Custom Theme"  | "Roboto Flex"     | "Roboto Flex" | "Sucessfully Created Application" | "This is required field!" | "Projects"               |
      | "dummy"  | "1234567890" | "Projects"      | " Web App "      | ""                | "Application name available."                    | "Demo Application Description"                                                           | "Custom Theme"  | "Roboto Flex"     | "Roboto Flex" | "Sucessfully Created Application" | "This is required field!" | "Projects"               |
      | "dummy"  | "1234567890" | "Projects"      | " Web App "      | "D"               | "Application name is required!"                  | "Demo Application Description"                                                           | "Custom Theme"  | "Roboto Flex"     | "Roboto Flex" | "Sucessfully Created Application" | "This is required field!" | "Projects"               |
